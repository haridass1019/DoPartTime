  ...
  useEffect(() => {
    async function fetchDetails() {
      ...
      if (docSnap.exists()) {
        ...
        const companyDocRef = doc(db, 'company', jobData.company);
        ...
        if (companyDocSnap.exists()) {
         ...
         const categoryDetailsPromises = jobData.category.map(async (categoryId: string) => {
    ...
    <div>
       <Head>
        <script
          ...
          dangerouslySetInnerHTML={{ __html: seoScript }}
        />
      </Head>
